...
from .models import TbPlan , TbCustomer , TbOrder , TbItem , TbMaterial , TbProcess, TbProductionLog, TbMachine
...
class TbCustomersCreateSerializer(serializers.ModelSerializer):
    class Meta:
        model = TbCustomer
        fields = ('customer_name','customer_code','customer_phone','representative_name','representative_phone')
...
class TbItemsCreateSerializer(serializers.ModelSerializer):
    class Meta:
        model = TbItem
        fields = ('item_code','item_name','unit')
...
class TbMachineSerializer(serializers.ModelSerializer):
    class Meta:
        model = TbMachine
        fields = ('machine_code','machine_name','line_name','manager_main','manager_sub')
