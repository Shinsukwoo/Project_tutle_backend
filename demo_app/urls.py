...
from .views import TbPlanAPIView , TbPlanOrderCreateAPIView , TbPlanOrderRUDAPIView , TbPlanTestAPIView , TbProductionLogAPIView , TbMachineAPIView
from .views import TbProductionLogRealTimeAPIView
...
urlpatterns = [
    ...
    path('machine/', TbMachineAPIView.as_view()),
    path('productionlog2/', TbProductionLogRealTimeAPIView.as_view()),
]
